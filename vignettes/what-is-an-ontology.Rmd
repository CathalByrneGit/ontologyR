...
This is what an **ontology** is: a formal, shared vocabulary + rules for how terms map onto data.
...
- See `vignette("datasets-and-materialization")` for the factory analogy: tracking data assets
- See `vignette("transforms-and-lineage")` for the assembly line analogy: data pipelines
- See `vignette("governance-gates")` for the airport security analogy: quality controls
- See `vignette("end-to-end-workflow")` for a complete healthcare example
